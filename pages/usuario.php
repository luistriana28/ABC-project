            ...
            <div class="row">
                <div class="col-sm-2 col-md-2 sidebar">
                    <ul class="nav nav-sidebar">
                        ...
                        <li>
                            <a href="#Menu1" data-toggle="collapse" data-parent="#MainMenu"><span class="glyphicon glyphicon-education"></span> Alumnos</a>
                        </li>
                        
                        <div class="collapse" id="Menu1">
                            <li><a id="pag_reg_alumno2" class="list-group-item">Registrar</a></li>
                            <li><a id="pag_cal_alumno" class="list-group-item">Calificaciones</a></li>
                            <li><a id="pag_rep_alumno" class="list-group-item">Reporte</a></li>
                        </div>
                        
                        <li>
                            <a href="#Menu2" data-toggle="collapse" data-parent="#MainMenu"><span class="glyphicon glyphicon-briefcase"></span> Profesores</a>
                        </li>
                        <div class="collapse" id="Menu2">
                            <li><a id="pag_grupos_prof" class="list-group-item">Grupos</a></li>
                            <li><a id="pag_alumnos_prof" class="list-group-item">Alumnos</a></li>
                            <li><a id="pag_cal_prof" class="list-group-item">Calificaciones</a></li>
                        </div>
